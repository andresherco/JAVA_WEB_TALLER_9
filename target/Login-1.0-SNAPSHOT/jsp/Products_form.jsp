...
<head>
    ...
    <!-- FAVICON -->
    <link rel="shortcut icon" type="image/png" href="${pageContext.request.contextPath}/img/productos-design-sketch-name.png"/>
    <!-- CSS -->
    <link rel="stylesheet" href="${pageContext.request.contextPath}/css/Products.css">
</head>
<body>
<h1 class="form-title">Formulario de productos</h1>
<form action="${pageContext.request.contextPath}/register-products" method="get">
